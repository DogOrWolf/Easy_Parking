...
public class MainActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, AMap.OnMarkerClickListener, RouteSearch.OnRouteSearchListener {
...
//                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ROSE));
    ...
    private com.amap.api.services.core.LatLonPoint toPosition;
    private com.amap.api.services.core.LatLonPoint fromPosition;
        ...
        if (tv_navigation != null) {
            tv_navigation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(MainActivity.this, "导航路线规划中..", Toast.LENGTH_SHORT).show();
    ...
    public void onWalkRouteSearched(WalkRouteResult walkRouteResult, int i) {
        Toast.makeText(MainActivity.this, "code::"+i, Toast.LENGTH_SHORT).show();
        if (i == 1000) {
            Toast.makeText(MainActivity.this, "path::"+walkRouteResult.getPaths().size(), Toast.LENGTH_SHORT).show();
            if (walkRouteResult.getPaths().size() > 0) {

                for (int j = 0; j < walkRouteResult.getPaths().size(); j++) {
                    WalkPath walkPath = walkRouteResult.getPaths().get(j);
                    WalkRouteOverlay walkRouteOverlay = new WalkRouteOverlay(
                            MainActivity.this, aMap, walkPath, fromPosition, toPosition);
            ...
            Toast.makeText(MainActivity.this, "计算路线失败", Toast.LENGTH_SHORT).show();
        }
